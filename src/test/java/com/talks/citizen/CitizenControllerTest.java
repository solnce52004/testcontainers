...
class CitizenControllerTest extends AbstractIntegrationTest {
    ...
    @Test
    void getCitizenStatistic_forJaneMoscow() {
        ...
        ResponseEntity<CitizenStatisticDto> entity = restTemplate
                .getForEntity(
                        "http://localhost:" + port + "/citizens/98y45764hf294fb29248fasd",
                        CitizenStatisticDto.class);
    ...
    @Test
    void getCitizenStatistic_forBobRome() {
        ...
        new MockServerClient(mockServer.getHost(), mockServer.getServerPort())
                ...
                .respond(
                        response()
                                .withBody("[{\"sum\":1499.50}]")
                                .withHeader(CONTENT_TYPE, APPLICATION_JSON_VALUE)
                );

        ResponseEntity<CitizenStatisticDto> entity = restTemplate
                .getForEntity(
                        "http://localhost:" + port + "/citizens/1234hf294fb29248fqwe",
                        CitizenStatisticDto.class
                );
